...
class Minimalist extends Component {
  render() {
    return (
      ...
      >
        <header style={{backgroundColor: `${this.props.headerColor}`, color: `${this.props.headerTextColor}`}} className="d-flex justify-between items-center font-sans w-full h-1/6">
          <div className="col-md-7">
            <div className="h4">{this.props.user.name}</div>
            <div className="h4">{this.props.user.wantedJobTitle}</div>
          </div>
        ...
        <section className="font-sans w-full mb-5 px-5">
          <div className="text-md text-black pt-3 border-bottom tracking-widest">
            SUMMARY
          </div>
        ...
        <section className="flex flex-col font-sans w-full mb-5 px-5">
          <div className="text-md border-bottom tracking-widest">SKILLS</div>
          <div>
        ...
        <section className="flex flex-col font-sans w-full mb-5 px-5">
          <div className="text-md border-bottom tracking-widest">
        ...
        <section className="w-full mb-5 px-5">
          <div className="text-md border-bottom tracking-widest">
            PROJECTS
          </div>
          ...
          {[...Array(this.props.eduCount)].map((e, i) => (
            <div className="flex flex-col" key={`emp${i}`}>
              <div className="d-flex justify-between">
                ...
                <div className="ml-4">
                  <div className="d-inline-block text-sm pt-3 text-gray-dark">
                    {this.props.education.eduStartDate[`eduStartDate${i + 1}`]}{" "}
                    -
                  </div>
                  <div className="d-inline-block text-sm pt-3 pl-3 text-gray-dark">
