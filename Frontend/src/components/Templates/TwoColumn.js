...
class TwoColumn extends Component {
  ...
  render() {
    return (
      ...
      >
        <header style={{color: `${this.props.headerTextColor}`}} className="p-2 flex flex-col font-sans">
          <div className="bg-gray-100 h-1/6 w-1/4"></div>
          <div style={{backgroundColor: `${this.props.headerColor}`}} className="pt-4 pb-4">
            <div className="h4 m-2">{this.props.user.name}</div>
            <div className="h4 m-2">{this.props.user.wantedJobTitle}</div>
          </div>
        </header>
        <div className="d-flex font-sans">
          <div className="bg-light col-md-4 mt-0.5">
            <section className="flex flex-col divide-y divide-black w-full mb-5 px-5 pt-3">
              <div className="text-md text-black border-bottom tracking-widest">SKILLS</div>
              <div>
                {this.props.user.skills == null
                  ...
                  : this.props.user.skills
                      .split(",")
                      .map((skill) => (
                        <div className="inline-block px-1 mt-1 mx-1 badge badge-dark text-sm text-white" key={skill}>
                          {skill}
                        </div>
                      ))}
              </div>
            ...
            <div className="flex flex-col px-5">
              <div className="text-md text-black border-bottom tracking-widest">
                CONTACT
              </div>
          ...
          <section className="flex flex-col w-full mb-5 px-5">
              <div className="text-md text-black pt-3 border-bottom border-black">
                SUMMARY
              </div>
            ...
            <section className="flex flex-col text-black w-full mb-5 px-5">
              <div className="text-md text-black border-bottom">
              ...
              {[...Array(this.props.empCount)].map((e, i) => (
                <div className="flex flex-col" key={`emp${i}`}>
                  <div className="d-flex justify-between">
                    ...
                    <div className="ml-4">
                      <div className="d-inline-block text-sm pt-3 text-black">
                        {
                      ...
                      <div className="d-inline-block text-sm pt-3 pl-3 text-black">
